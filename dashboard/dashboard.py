...
# Streamlit Title
st.title("Kualitas Udara di Changping dan Dingling")
...
if questions == "Bagaimana pola perubahan tingkat PM2.5 dari waktu ke waktu di dua lokasi tersebut?":
    ...
    # Kesimpulan PM10
    st.write(""" 
    - **Kesimpulan PM10**: Tingkat PM10 juga menunjukkan pola serupa, dengan konsentrasi yang lebih tinggi di Changping dibandingkan 
    Dingling, terutama pada musim dingin.
    """)
    ...
    st.write("""
    - **Dengan menggunakan boxplot, kita dapat melihat distribusi dan outlier dari tingkat PM2.5 di masing-masing stasiun. Memberi indikasi 
    tentang seberapa sering terjadi level polusi yang tinggi dan di mana perhatian lebih diperlukan. """)
    ...
    # Kesimpulan
    st.write("""
    - **Boxplot PM10 memberikan wawasan lebih lanjut tentang sebaran dan frekuensi level tinggi PM10. 
    Penting untuk memahami dampak polusi debu terhadap kesehatan publik dan kualitas hidup. """)
